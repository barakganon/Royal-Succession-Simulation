...
class DatabaseInitializer:
    ...
    def _create_tables_if_not_exist(self):
        ...
        try:
            ...
            if not existing_tables:
                ...
                # Schema changes are now managed by Flask-Migrate / Alembic.
                # Run `flask db upgrade` to apply pending migrations.
                # Legacy ALTER TABLE / table-creation guards removed (Story 11-2).
    ...
    # perform_migrations(), _get_db_version(), _set_db_version(), and
    # _migrate_from_v0_to_v1() were removed in Story 11-2 when the project
    # migrated from ad-hoc ALTER TABLE scripts to Flask-Migrate / Alembic.
