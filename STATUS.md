...
| 12-1 | Chronicle compiler: `compile_chronicle()` → ChronicleBook (reign chapters via reign_start_year, NOT is_monarch; Founding chapter; ChronicleEntryDB prose bucketed by year; weighted HistoryLogEntryDB highlights top-5/chapter). Live-smoke caught + fixed nullable-year crash. Sonnet on live main; Opus verify — 547 green | Done |
